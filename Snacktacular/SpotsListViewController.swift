...
class SpotsListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        spots = Spots()
        spots.spotArray.append(Spot(name: "El Pelon", address: "Common Ave", coordinate: CLLocationCoordinate2D(), averageRating: 0.0, numberOfReviews: 0, postingUserID: "", documentID: ""))
...
extension SpotsListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.ratingLabel.text = "Avg. Rating: \(spots.spotArray[indexPath.row].averageRating)"
